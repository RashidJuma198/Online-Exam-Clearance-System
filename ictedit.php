...
/*$sql="SELECT tablestudent.User_ID,tablestudent.First_Name,tablestudent.Last_Name,tablestudent.ADM_No,
 tablestudent.Exam_Series,tablestudent.Mobile_Phone,tablestudent.Department,tablestudent.Module,
  tablestudent.Diploma,tablestudent.ID_No,tablestudent.Latest_Knec_Slip,tablestudent.Birth_Cert_No ,
  hod_table.Hod_ID,hod_table.Class,hod_table.Hod_Module,hod_table.Percentage_Class_Attendance,
   hod_table.Examination_Fee,hod_table.Approved,hod_table.Reason_If_Not_Approved,hod_table.Hod_Name, 
   hod_table.Period_Checked_By_Hod FROM `hod_table`,`tablestudent` WHERE tablestudent.User_ID='".$UserId."';";
*/
$UserId = $_GET['GetID'];
...
<body style="background-color:rgb(148, 243, 4)">
    ...
    <fieldset class="hod">     
        ...
        <input type="text" name="mmodule" id="mmodule"  required >
        ...
        <input type="number" name="examfee" id="examfee" required >
